...
let
      ...
      modules = [
        ...
        inputs.home-manager.nixosModules.home-manager
        {
          ...
          home-manager.extraSpecialArgs = { 
            inherit inputs outputs desktop hostname username; 
          };
        }
      ] ++ modules;
    };
  ...
  mkPkgs = platform: import inputs.nixpkgs {
    system = platform;
...
in
{
  ...
  inherit mkNixOS mkHome forAllSystems importDirectory;
  inherit isWorkstation isLaptop isISO optionalPackages mkPkgs;
}